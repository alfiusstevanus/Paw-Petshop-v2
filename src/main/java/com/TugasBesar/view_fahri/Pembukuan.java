...
public class Pembukuan extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        panel_background.setBackground(new java.awt.Color(69, 60, 103));

        panel_header.setBackground(new java.awt.Color(60, 239, 198));
        ...
        txtPemasukan.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
